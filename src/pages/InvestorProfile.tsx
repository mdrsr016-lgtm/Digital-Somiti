        ...
        <div className="max-w-4xl w-full mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 space-y-6">
              <div className="login-card !max-w-none items-center p-8 text-center relative">
                <div className="relative group">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-primary/30 group-hover:border-blue-primary transition-all duration-300">
                    <img
                      src={
                        profile?.avatar_url ||
                  ...
                  <button className="absolute bottom-1 right-1 p-2 bg-blue-primary rounded-full shadow-lg hover:scale-110 transition-transform">
                    <Camera size={16} />
                  </button>
                </div>
                <div className="mt-4">
                  ...
                  <p className="text-blue-primary font-medium opacity-80">
                    @{profile?.username}
                  </p>
                </div>
                <div className="w-full h-px bg-white/10 my-6"></div>
                <button className="w-full py-3 rounded-2xl bg-blue-primary/10 border border-blue-primary/20 text-blue-primary hover:bg-blue-primary/20 transition-all flex items-center justify-center gap-2 font-semibold">
                  <Edit2 size={16} />
                  {t.editProfile}
                </button>
              </div>
              ...
              <div className="login-card !max-w-none p-6 space-y-4">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <div className="login-card !max-w-none p-8 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="p-4 rounded-2xl bg-blue-primary/5 border border-blue-primary/10 space-y-2">
                    <div className="flex items-center justify-between">
                      <Wallet className="text-blue-primary" size={20} />
                      <span className="text-xs font-bold text-blue-primary uppercase">
                        Total
                      </span>
                    </div>
                    <p className="text-2xl font-bold">৳ 25,000</p>
                    <p className="text-xs opacity-50">{t.totalInvestment}</p>
                  </div>
                  <div className="p-4 rounded-2xl bg-green-500/5 border border-green-500/10 space-y-2">
                    ...
                    <p className="text-xs opacity-50">{t.roi}</p>
                  </div>
                  <div className="p-4 rounded-2xl bg-purple-500/5 border border-purple-500/10 space-y-2">
                    ...
                    <p className="text-2xl font-bold">৳ 28,125</p>
                    <p className="text-xs opacity-50">{t.currentValue}</p>
                  </div>
                </div>
              </div>
            </div>
